...
python api/scripts/scrapers/main.py
...
python api/scripts/grupos/grupos.py

echo "📦 Llamando a /api/noticias/agrupar-bbdd..."
curl -X POST http://localhost:3000/api/noticias/agrupar-bbdd
